...
// 目标列表
const targets = ref([
  { id: 1, type: '体重目标', value: '70kg', current: '75kg', deadline: '2026-12-31', progress: 50 },
  { id: 2, type: '每周运动次数', value: '3次', current: '2次', deadline: '2026-08-31', progress: 66 },
  { id: 3, type: '每日步数', value: '10000步', current: '8000步', deadline: '2026-09-30', progress: 80 }
])
...
const addTarget = () => {
  ...
  targets.value.push({
    id: Date.now(),
    type: typeMap[newTarget.type] || newTarget.type,
    value: newTarget.value + (newTarget.type === 'WEIGHT' ? 'kg' : newTarget.type === 'STEPS' ? '步' : '次'),
    current: newTarget.type === 'WEIGHT' ? '0kg' : '0次',
